					...
					<div className='row'>
						...
						<div className='col-lg-6 text-lg-end'>
							<ul className='footer-bottom-nav'>
								<li>
									<a target='_blank' href='https://www.linkedin.com/in/syed-jawad-shah-06974b206/'>
										LinkedIn
									</a>
								</li>
								<li>
								...
								<li>
									<a target='_blank' href='https://github.com/Jawad1529'>
										Github
									</a>
								</li>
							</ul>
					...
					<div className='col-xl-6 col-lg-7'>
						<div className='footer-widget widget_text text-center text-lg-start wow fadeInUp delay-0-2s'>
							<div className='text pb-20'>
								...
								agreed to accept all terms and conditions written in here.
							</div>
						</div>
					</div>
			...
			<div className='footer-bottom pt-10 pb-15'>
				<div className='container'>
					<div className='copyright-text text-center'>
						<p>
							Copyright @{date},{' '}
							<Link legacyBehavior href='https://nextonprime.com'>
								NEXTONPRIME
							</Link>{' '}
							All Rights Reserved
						</p>
